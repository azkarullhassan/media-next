...
const Eight = () => {
  return (
   <section className='w-full bg-[#FFF7F2] py-28'>
    <main className='mx-auto max-w-[70rem]'>
    ...
    <div className='flex md:flex-row flex-col justify-center gap-28'>
        ...
        <div className='md:p-0 p-5 md:w-1/2 pt-12 '>
             <h1 className='text-[#FF6947] font-extrabold text-[16px]'>Testimonials</h1>
             <h2 className='font-extrabold text-[40px]'>Don't take our word for it, take theirs</h2>
        </div>
    </div>
