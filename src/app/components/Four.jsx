     ...
     <div className='w-full md:w-1/2 flex justify-center  '>
        ...
        <div className=' pt-44 pl-8'>
         <h1 className="font-extrabold text-[44px]">Introducing Your Win- <span className='text-[#FF6947]'>Win Solution</span></h1>
          <p className='font-normal text-[18px] pt-6'>At AMT MEDIA, we resonate with the hurdles you face. Led by a commitment to overcommunication, undivided attention, and unmatched reliability, we pledge to make you feel valued and understood. </p>
